#unnormalized, with rotation, default urerf paramters, with noise
...
rota=replicate(9, runif(9, 1, 10))
rota_high_dim_noise_data=high_dim_noise_data%*%rota


g_noise1=Urerf(rota_high_dim_noise_data, trees = 300, Progress = TRUE, splitCrit = "bicfast", normalizeData = FALSE)
...
save(D_rf_noise1_precision_list, D_iso_noise1_precision_list, D_umap_noise1_precision_list, file="exp_2_d.Rdata")
