...
g=Urerf(high_dim_noise_data, trees = 300, Progress = TRUE, splitCrit = "bicfast")
...
# generate D_eucd
D_eucd = as.matrix(dist(high_dim_noise_data))
iso_dist = as.matrix(isomapdist(D_eucd, k=5))
...
a = umap(high_dim_noise_data, config = custom.settings)
...
save(D_iso_p_r_list, file = "mph_experiment/exp_2_a_iso.RData")
save(D_umap_p_r_list, file = "mph_experiment/exp_2_a_umap.RData")
save(D_rf_p_r_list, file = "mph_experiment/exp_2_a_rf.RData")
save(D_rf2_p_r_list, file = "mph_experiment/exp_2_a_power.RData")
save(D_rf3_p_r_list, file = "mph_experiment/exp_2_a_td.RData")